...
public class SwerveModule implements Sendable {
    ...
    public SwerveModule(SwerveModuleConstants moduleConstants) {
        ...
        _encoder = new CANCoderFactory(moduleConstants.CANcoderId, SwerveConstants.canBus, SwerveConfigs.canCoder,
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop) {
        ...
        double angle = ((Math.abs(desiredState.speedMetersPerSecond) <= (SwerveConstants.maxSpeed * 0.01)) ? _lastAngle
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop) {
        ...
        if (isOpenLoop) {
            ...
            _driveVelocity.Velocity = Util.MPSToRPS(desiredState.speedMetersPerSecond * ratio,
